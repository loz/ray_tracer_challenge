...
pattern = ring_pattern(color(0.20, 0.20, 0.20), color(0.5, 0.5, 0.5))
...
pattern = ring_pattern(color(0.1, 1.0, 0.1), color(0.5, 1.0, 0.5))
...
pattern = ring_pattern(color(0.1, 0.1, 1.0), color(0.5, 0.5, 1.0))
...
pattern = ring_pattern(color(1.0, 0.1, 0.1), color(1.0, 0.5, 0.5))
...
puts "Saving..."
canvas.to_ppm_file("rings_scene.ppm")
