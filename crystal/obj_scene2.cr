...
puts "Loading Object.."
obj = ObjFile.parse_file("teapot.obj")
puts "Converting To Group.."
teapot = obj.to_group
teapot.transform = 
                   translation(-2.0, -5.0, 0.0) *
                   scaling(5.0, 5.0, 5.0) *
...
camera.transform = view_transform(point(0.0, 1.0, -35.0),
                                  point(0.0, 0.0, 0.0),
                                  vector(0.0, 1.0, 0.0))
puts "Rendering..."
...
puts "Saving..."
canvas.to_ppm_file("obj_scene2.ppm")
